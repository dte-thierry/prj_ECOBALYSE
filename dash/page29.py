...
# Créer la mise en page de la page 29
def create_page29_layout():
    return html.Div([
        html.H1("Prédiction d'ecoscore 'ecs', pour la catégorie : Pantalon", className='text-center my-4'),
        
        html.Div([
            html.Div([
                html.Label('Libelle', className='form-label'),
                dcc.Input(id='libelle', type='text', value='Pantalon (exemple ML)', className='form-control', readOnly=True),
            ], className='mb-3'),
            
            html.Div([ 
                html.Label('Masse (en kg. Min 0.30 | Max 0.80)', className='form-label'),
                dcc.Input(id='masse', type='number', value=0.45, min=0.30, max=0.80, step=0.05, className='form-control'),
                dbc.Tooltip(
                    info_masse_content,
                    target="masse",
                    placement="right",
            ...
            html.Div([
                ...
                dcc.Input(id='product', type='text', value='pantalon', className='form-control', readOnly=True),
                dbc.Tooltip(
            ...
            html.Div([
                html.Label("Price (Min 20€ | Max 100€. Prix du produit, en Euros)", className='form-label'),
                dcc.Input(id='price', type='number', value=20.0, min=20.0, max=100.0, step=1.0, className='form-control'),
            ], className='mb-3'),
