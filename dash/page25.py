...
# Créer la mise en page de la page 25
def create_page25_layout():
    return html.Div([
        html.H1("Prédiction d'ecoscore 'ecs', pour la catégorie : Jean", className='text-center my-4'),
        
        html.Div([
            html.Div([
                html.Label('Libelle', className='form-label'),
                dcc.Input(id='libelle', type='text', value='Jean (exemple ML)', className='form-control', readOnly=True),
            ], className='mb-3'),
            
            html.Div([ 
                html.Label('Masse (en kg. Min 0.40 | Max 1.00)', className='form-label'),
                dcc.Input(id='masse', type='number', value=0.45, min=0.40, max=1.00, step=0.05, className='form-control'),
                dbc.Tooltip(
                    info_masse_content,
                    target="masse",
                    placement="right",
            ...
            html.Div([
                ...
                dcc.Input(id='product', type='text', value='jean', className='form-control', readOnly=True),
                dbc.Tooltip(
            ...
            html.Div([
                html.Label("Price (Min 20€ | Max 50€. Prix du produit, en Euros)", className='form-label'),
                dcc.Input(id='price', type='number', value=20.0, min=20.0, max=50.0, step=1.0, className='form-control'),
            ], className='mb-3'),
