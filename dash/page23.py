...
# Créer la mise en page de la page 23
def create_page23_layout():
    return html.Div([
        html.H1("Prédiction d'ecoscore 'ecs', pour la catégorie : Chaussettes", className='text-center my-4'),
        
        html.Div([
            html.Div([
                html.Label('Libelle', className='form-label'),
                dcc.Input(id='libelle', type='text', value='Chaussettes (exemple ML)', className='form-control', readOnly=True),
            ], className='mb-3'),
            
            html.Div([ 
                html.Label('Masse (en kg. Min 0.02 | Max 0.10)', className='form-label'),
                dcc.Input(id='masse', type='number', value=0.04, min=0.02, max=0.10, step=0.01, className='form-control'),
                dbc.Tooltip(
                    info_masse_content,
                    target="masse",
                    placement="right",
            ...
            html.Div([
                ...
                dcc.Input(id='product', type='text', value='chaussettes', className='form-control', readOnly=True),
                dbc.Tooltip(
            ...
            html.Div([
                html.Label("Price (Min 2€ | Max 15€. Prix du produit, en Euros)", className='form-label'),
                dcc.Input(id='price', type='number', value=4.0, min=2.0, max=15.0, step=1.0, className='form-control'),
            ], className='mb-3'),
