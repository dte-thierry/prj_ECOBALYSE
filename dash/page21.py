...
# Créer la mise en page de la page 21
def create_page21_layout():
    return html.Div([
        html.H1("Prédiction d'ecoscore 'ecs', pour la catégorie : Boxer / slip (tricoté)", className='text-center my-4'),
        
        html.Div([
            html.Div([
                html.Label('Libelle', className='form-label'),
                dcc.Input(id='libelle', type='text', value='Boxer / slip tricoté (exemple ML)', className='form-control', readOnly=True),
            ], className='mb-3'),
            
            html.Div([ 
                html.Label('Masse (en kg. Min 0.03 | Max 0.15)', className='form-label'),
                dcc.Input(id='masse', type='number', value=0.03, min=0.03, max=0.15, step=0.01, className='form-control'),
                dbc.Tooltip(
                    info_masse_content,
                    target="masse",
                    placement="right",
            ...
            html.Div([
                ...
                dcc.Input(id='product', type='text', value='slip', className='form-control', readOnly=True),
                dbc.Tooltip(
            ...
            html.Div([
                html.Label("Price (Min 4€ | Max 10€. Prix du produit, en Euros)", className='form-label'),
                dcc.Input(id='price', type='number', value=4.0, min=4.0, max=10.0, step=1.0, className='form-control'),
            ], className='mb-3'),
